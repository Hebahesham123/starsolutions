...
export const metadata: Metadata = {
  alternates: alternates('ar', '/solutions'),
  title: t('page.solutions.title'),
  description: t('page.solutions.lede'),
};
...
export default function SolutionsIndexPage() {
  ...
  return (
    <>
      <PageHead
        eyebrow={t('page.solutions.eyebrow')}
        title={t('page.solutions.title')}
        lede={t('page.solutions.lede')}
        crumbs={[{ href: localeHref(locale, '/'), label: t('crumbs.home') }, { label: t('page.solutions.crumb') }]}
      />
          ...
          <div className="index-grid">
            {items.map((item, i) => (
              <Reveal as="article" key={item.id} delay={i * 0.05}>
                <Link
                  href={localeHref(locale, `/solutions/${item.slug}`)}
