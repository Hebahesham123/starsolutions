...
export const metadata: Metadata = {
  alternates: alternates('ar', '/systems'),
  title: t('page.systems.title'),
  description: t('page.systems.lede'),
};
...
export default function SystemsIndexPage() {
  ...
  return (
    <>
      <PageHead
        eyebrow={t('page.systems.eyebrow')}
        title={t('page.systems.title')}
        lede={t('page.systems.lede')}
        crumbs={[{ href: localeHref(locale, '/'), label: t('crumbs.home') }, { label: t('page.systems.crumb') }]}
      />
          ...
          <div className="index-grid">
            {items.map((item, i) => (
              <Reveal as="article" key={item.id} delay={i * 0.05}>
                <Link
                  href={localeHref(locale, `/systems/${item.slug}`)}
